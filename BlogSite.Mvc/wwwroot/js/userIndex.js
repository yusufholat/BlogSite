                                ...
                                $.each(userListDto.Users.$values,
                                    function (index, user) {
                                        dataTable.row.add([
                                            ...
                                            user.Email,
                                            user.PhoneNumber,
                                            `<img src="/img/${user.Picture}" alt="${user.Picture}" style="max-height: 50px; max-width: 50px;" />`,
    ...
    $(document).on('click',
        ...
        function (event) {
            ...
            Swal.fire({
                ...
                text: `${userName} adlı kullanici silinicektir!`,
                icon: 'warning',
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (userDto.ResultStatus === 0) {
                                Swal.fire(
                                    'Silindi!',
                                    `${userDto.User.UserName} adlı kullanici başarıyla silinmiştir.`,
                                    'success'
                                );
